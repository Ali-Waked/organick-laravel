...
class SubscriberController extends Controller
{
  ...
  {
    $this->subscriberService->verify($request->token);
  ...
  {
    $this->subscriberService->changeStatus($subscriber);
    return Response::json([
      'message' => "Subscription status updated to " . ($subscriber->is_subscribed ? 'subscirbe' : 'unsubscribe') . " successfully",
    ]);
  }
   ...
   * @return \Illuminate\Http\JsonResponse
   */
  // public function unsubscribe(Subscriber $subscriber): JsonResponse
  // {
  //   $this->subscriberService->changeStatus($subscriber);
