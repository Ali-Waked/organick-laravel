        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <a href="auth/x/redirect">login with X</a>
                    @if (Route::has('login'))
                ...
                <form :action="URL::current()" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="file" name="image" id="image" class="block w-full text-sm text-gray-900" />
                ...
                <form action="/send-mail"><button type="submit">Send Mail</button></form>
                <main class="mt-6">
